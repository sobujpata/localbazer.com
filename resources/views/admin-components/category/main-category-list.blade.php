...
<div class="all-Orders-Details">
    <div class="recentCustomers">
        <div class="cardHeader">
            ...
            <button type="button" class="black-70-button" style="margin-bottom:10px;"><a href="{{ url('/main-category-add') }}">Main Category Add</a></button>
    ...
    // console.log(res);
        ...
        document.querySelectorAll('.editBtn').forEach(button => {
            button.addEventListener('click', function () {
                ...
                window.location.href = `/main-category-edit?id=${id}`;
            });
        });
        document.querySelectorAll('.deleteBtn').forEach(button => {
            button.addEventListener('click', function () {
                ...
                window.location.href = `/main-category-delete?id=${id}?imgPath=${imgPath}`;
            });
        });
